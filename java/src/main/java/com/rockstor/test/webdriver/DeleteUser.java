...
public class DeleteUser {
	...
	public void testDeleteUser() throws Exception {
		try{
			...
			//Click Delete Button
			WebElement userRow = driver.findElement(By.xpath("//*[@id='users-table']/tbody/tr[td[contains(text(),'rockstorUser')]]"));
			WebElement editUser = userRow.findElement(By.xpath("td/a/i[contains(@class,'icon-trash')]"));
			editUser.click();
			...
			/// Login back with the deleted user
			...
			username = driver.findElement(
					By.id("username"));
			username.sendKeys("rockstorUser");
