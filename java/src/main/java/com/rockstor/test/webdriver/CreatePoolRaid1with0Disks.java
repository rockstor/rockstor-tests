...
public class CreatePoolRaid1with0Disks {
	...
	@Test
	public void testPoolRaid1Disks0() throws Exception {
		try{
			...
			WebElement verifyErrorMsg = driver.findElement(
					By.xpath("//div/form/label[text()='Raid1 requires at least 2 disks to be selected']"));
