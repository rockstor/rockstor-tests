...
public class CreateShareSizeinMb {
	...
	public static void main(String[] args) throws IOException {
		...
		try{
			...
			selectSizeDroplist.selectByIndex(1); // 1 is MB
		...
		//catch any exceptions by taking screenshots
			...
			FileUtils.copyFile(screenshotFile,new File("/home/priya/rockstor-tests/webdriver/java/ScreenShots/ShareSizerinMb.png"));
