...
public class CreateShareSizeinPbIntermsofKb {
	...
	public static void main(String[] args) throws IOException {
		...
		try{
			...
			shareSize.sendKeys("1099511627776"); // 1pb = 1099511627776 kb
			

			Select selectSizeDroplist = new Select(driver.findElement(By.id("size_format")));   
			selectSizeDroplist.selectByIndex(0); // in kb	
		...
		//catch any exceptions by taking screenshots
			...
			FileUtils.copyFile(screenshotFile,new File("/home/priya/rockstor-tests/webdriver/java/ScreenShots/ShareSizerPbintermsofkb.png"));
