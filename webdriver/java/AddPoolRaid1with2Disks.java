...
public class AddPoolRaid1with2Disks {
	...
	public static void main(String[] args) throws IOException {
		...
		try{
			...
			WebElement myWaitElement3 = (new WebDriverWait(driver, 30))
		...
		//catch any exceptions by taking screenshots
			...
			FileUtils.copyFile(screenshotFile,new File("/home/priya/rockstor-tests/webdriver/java/ScreenShots/AddPool_Raid12Disks.png"));
