...
public class AddPoolRaid1with0Disks {
	...
	public static void main(String[] args) throws IOException {
		...
		//catch any exceptions by taking screenshots
			...
			FileUtils.copyFile(screenshotFile,new File("/home/priya/rockstor-tests/webdriver/java/ScreenShots/Raid1with0DiskPool.png"));
