...
public class AddPoolRaid10with3Disks {
	...
	public static void main(String[] args) throws IOException {
		...
		//catch any exceptions by taking screenshots
			...
			FileUtils.copyFile(screenshotFile,new File("/home/priya/rockstor-tests/webdriver/java/ScreenShots/AddPool_Raid10With3Disks.png"));
